 ...
 */
const CHROMIUM_SCHEMA: BrowserSchema = {
  tableName: "cookies",
  nameColumn: "name",
  valueColumn: "value",
...
const BROWSER_SCHEMAS: Record<SqlBrowserType, BrowserSchema> = {
  chrome: CHROMIUM_SCHEMA,
  chromium: CHROMIUM_SCHEMA,
  whale: CHROMIUM_SCHEMA,
  edge: CHROMIUM_SCHEMA,
  opera: CHROMIUM_SCHEMA,
  "opera-gx": CHROMIUM_SCHEMA,
  brave: CHROMIUM_SCHEMA,
  arc: CHROMIUM_SCHEMA,
  vivaldi: CHROMIUM_SCHEMA,
  firefox: {
