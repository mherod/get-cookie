...
describe("errorUtils - getErrorDetails", () => {
...
describe("errorUtils - errorMessageContains", () => {
  ...
  it("should work with string errors", () => {
    expect(errorMessageContains("Permission denied", "permission")).toBe(true);
...
describe("errorUtils - getDatabaseErrorType", () => {
  ...
  it("should detect not found errors", () => {
    ...
    expect(getDatabaseErrorType(new Error("File not found"))).toBe("not_found");
  });
...
describe("errorUtils - formatErrorForLogging", () => {
...
describe("errorUtils - hasErrorMessage", () => {
...
describe("errorUtils - ensureError", () => {
...
describe("errorUtils - withErrorHandling", () => {
...
/**
 * Test retryWithBackoff with eventual success after retries
 */
async function testRetryWithEventualSuccess(): Promise<void> {
...
/**
 * Test retryWithBackoff failure after max attempts
 */
async function testRetryMaxAttempts(): Promise<void> {
...
/**
 * Test retryWithBackoff shouldRetry option
 */
async function testShouldRetryOption(): Promise<void> {
...
/**
 * Test retryWithBackoff exponential backoff with max delay
 */
...
describe("errorUtils - retryWithBackoff", () => {
  beforeEach(() => {
    jest.useFakeTimers();
  });
  ...
  it("should retry on failure and eventually succeed", async () => {
    await testRetryWithEventualSuccess();
  }, 10000);
